...
public class FPGrowthTest {
    ...
    public void testFPFromPaper()
    {
        ...
        List<ItemsetWithCount> itemsets = fp.getItemsetsSupportRatio(txns, .6);
    ...
    public void testFPLonger()
    {
        ...
        List<ItemsetWithCount> itemsets = fp.getItemsetsSupportRatio(txns, .2);
    ...
    public void simpleTest()
    {
        ...
        List<ItemsetWithCount> itemsets = fp.getItemsetsSupportRatio(txns, .7);
    ...
    public void dupTest()
    {
        ...
        List<ItemsetWithCount> itemsets = fp.getItemsetsSupportRatio(txns, .01);
